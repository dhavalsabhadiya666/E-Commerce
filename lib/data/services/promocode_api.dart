...
class PromocodeApi {
  ...
  Future<dynamic> getAllPromoCodes({@required BuildContext context, FormData data}) async {
    try {
      ApiResponseModel apiResponse = await _client.post('${Endpoints.getPromoCodes}', data: data);
